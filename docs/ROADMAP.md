...
| 15 | Show me, play me | "Show me the Eiffel Tower" (a picture: Wikipedia, then Openverse, frame mode); "show the Blond cover" (iTunes search, frame mode); "play the Gameboy video" (YouTube search, video mode). | **done** 2026-09-15, pictures 2026-09-22 |
