...
@main struct SettingsCatalogChecks {
    static func main() throws {
        ...
        for (query, route) in [("brightness", SettingsDestination.light), ("timer", .time), ("snooze", .time), ("nothing playing", .idle), ("leave", .idle), ("off", .idle), ("CLAUDE", .ask), ("api key", .services), ("color", .colour), ("COLOUR", .colour), ("éárwörm", .earworm), ("ｔｉｍｅ", .time), ("ip address", .addresses), ("wifi password", .guests), ("temperature", .weather), ("dynamic island", .lockScreen), ("dead pixel", .panel), ("diagnostics", .health), ("expiry", .note), ("minute", .time), ("morning", .wake), ("night", .sun)] {
