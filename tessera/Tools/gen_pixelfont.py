...
def main() -> None:
    ...
    parser.add_argument("--tessera-only", action="store_true", help="Leave the predecessor app untouched")
    ...
    region = AW_TEMPLATE % {"rows": "\n".join(rows), "aliases": alias_pairs, "normalize": NORMALIZE}
